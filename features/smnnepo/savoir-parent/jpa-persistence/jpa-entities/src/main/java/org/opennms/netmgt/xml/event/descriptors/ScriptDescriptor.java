...
@SuppressWarnings("all") public class ScriptDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ScriptDescriptor() {
        ...
        //-- _language
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_language", "language", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Script target = (Script) object;
                    target.setLanguage( (String) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
