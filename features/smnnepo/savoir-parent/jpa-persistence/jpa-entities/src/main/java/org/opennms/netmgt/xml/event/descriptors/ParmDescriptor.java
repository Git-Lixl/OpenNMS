...
@SuppressWarnings("all") public class ParmDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ParmDescriptor() {
        ...
        //-- _parmName
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_parmName", "parmName", org.exolab.castor.xml.NodeType.Element);
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Parm target = (Parm) object;
                    target.setParmName( (String) value);
                } catch (Exception ex) {
