...
@SuppressWarnings("all") public class OperactionDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OperactionDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _menutext
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_menutext", "menutext", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Operaction target = (Operaction) object;
                    target.setMenutext( (String) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
