...
@SuppressWarnings("all") public class ForwardDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ForwardDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _mechanism
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_mechanism", "mechanism", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Forward target = (Forward) object;
                    target.setMechanism( (String) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
