...
public class AnnotationBasedEventListenerAdapter implements StoppableEventListener, InitializingBean, DisposableBean {
     ...
     * @param annotatedListener a {@link Object} object.
    ...
    public void afterPropertiesSet() {
        ...
        if (m_name == null) {
            m_name = listenerInfo.getName();
        }

        if (m_logPrefix == null) {
            if (listenerInfo.getName() != null && !"".equals(listenerInfo.getName())) {
                m_logPrefix = listenerInfo.getName();
            } else {
                m_logPrefix = m_name;
            }
        }
    ...
    private static EventListener findEventListenerAnnotation(Object annotatedListener) {
        return null ;
            //TODO  annotatedListener.getClass().getAnnotation(EventListener.class);
    }
