...
@SuppressWarnings("all") public class ValueDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ValueDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- _encoding
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(String.class, "_encoding", "encoding", org.exolab.castor.xml.NodeType.Attribute);
        desc.setImmutable(true);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public Object getValue( Object object )
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Value target = (Value) object;
                    target.setEncoding( (String) value);
                } catch (Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
