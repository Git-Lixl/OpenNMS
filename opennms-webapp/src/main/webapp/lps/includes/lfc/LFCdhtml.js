...
if($5!=null){
if(!this.__LZdeleted){
var $lzsc$1084512677=this.setters
if($lzsc$1084512677&&$4 in $lzsc$1084512677){
this[$lzsc$1084512677[$4]]($5)
}else{
this[$4]=$5
var $lzsc$28574781="on"+$4
if($lzsc$28574781 in this){
if(this[$lzsc$28574781].ready){
this[$lzsc$28574781].sendEvent($5)
}
}
}
}
...
var $4=$3.call(this)
if(!this.__LZdeleted){
var $lzsc$799679159=this.setters
if($lzsc$799679159&&$2 in $lzsc$799679159){
this[$lzsc$799679159[$2]]($4)
}else{
this[$2]=$4
var $lzsc$921170843="on"+$2
if($lzsc$921170843 in this){
if(this[$lzsc$921170843].ready){
this[$lzsc$921170843].sendEvent($4)
}
}
}
}
...
if(!this.__LZdeleted){
var $lzsc$1259925218=this.setters
if($lzsc$1259925218&&$1 in $lzsc$1259925218){
this[$lzsc$1259925218[$1]]($2)
}else{
this[$1]=$2
var $lzsc$2050239162="on"+$1
if($lzsc$2050239162 in this){
if(this[$lzsc$2050239162].ready){
this[$lzsc$2050239162].sendEvent($2)
}
}
}
}
...
var $6=$4?this[$1]+$2:$2
if(!this.__LZdeleted){
var $lzsc$2019909555=this.setters
if($lzsc$2019909555&&$1 in $lzsc$2019909555){
this[$lzsc$2019909555[$1]]($6)
}else{
this[$1]=$6
var $lzsc$488895183="on"+$1
if($lzsc$488895183 in this){
if(this[$lzsc$488895183].ready){
this[$lzsc$488895183].sendEvent($6)
}
}
}
}
...
if(this[$1]){
if(!this.__LZdeleted){
var $lzsc$1830189523=this.setters
if($lzsc$1830189523&&$1 in $lzsc$1830189523){
this[$lzsc$1830189523[$1]]($2)
}else{
this[$1]=$2
var $lzsc$1673341809="on"+$1
if($lzsc$1673341809 in this){
if(this[$lzsc$1673341809].ready){
this[$lzsc$1673341809].sendEvent($2)
}
}
}
}
...
if(!this.__LZdeleted){
var $lzsc$1222442990=this.setters
if($lzsc$1222442990&&"x" in $lzsc$1222442990){
this[$lzsc$1222442990["x"]](0)
}else{
this["x"]=0
if("onx" in this){
if(this["onx"].ready){
...
if($1=="center"){
var $2=function(){
var $lzsc$1501865092=this.immediateparent.width/2-this.width/2
if(!this.__LZdeleted){
var $lzsc$468506626=this.setters
if($lzsc$468506626&&"x" in $lzsc$468506626){
this[$lzsc$468506626["x"]]($lzsc$1501865092)
}else{
this["x"]=$lzsc$1501865092
if("onx" in this){
if(this["onx"].ready){
this["onx"].sendEvent($lzsc$1501865092)
}
}
}
}
...
if($1=="right"){
var $2=function(){
var $lzsc$724850932=this.immediateparent.width-this.width
if(!this.__LZdeleted){
var $lzsc$1360862091=this.setters
if($lzsc$1360862091&&"x" in $lzsc$1360862091){
this[$lzsc$1360862091["x"]]($lzsc$724850932)
}else{
this["x"]=$lzsc$724850932
if("onx" in this){
if(this["onx"].ready){
this["onx"].sendEvent($lzsc$724850932)
}
}
}
}
...
if(!this.__LZdeleted){
var $lzsc$1051119601=this.setters
if($lzsc$1051119601&&"y" in $lzsc$1051119601){
this[$lzsc$1051119601["y"]](0)
}else{
this["y"]=0
if("ony" in this){
if(this["ony"].ready){
...
if($1=="middle"){
var $2=function(){
var $lzsc$615683890=this.immediateparent.height/2-this.height/2
if(!this.__LZdeleted){
var $lzsc$877639914=this.setters
if($lzsc$877639914&&"y" in $lzsc$877639914){
this[$lzsc$877639914["y"]]($lzsc$615683890)
}else{
this["y"]=$lzsc$615683890
if("ony" in this){
if(this["ony"].ready){
this["ony"].sendEvent($lzsc$615683890)
}
}
}
}
...
if($1=="bottom"){
var $2=function(){
var $lzsc$1279066491=this.immediateparent.height-this.height
if(!this.__LZdeleted){
var $lzsc$1668122993=this.setters
if($lzsc$1668122993&&"y" in $lzsc$1668122993){
this[$lzsc$1668122993["y"]]($lzsc$1279066491)
}else{
this["y"]=$lzsc$1279066491
if("ony" in this){
if(this["ony"].ready){
this["ony"].sendEvent($lzsc$1279066491)
}
}
}
}
...
if($1=="x"||$1=="y"){
$3.update($1)
var $lzsc$1148065457=($4-$3.offset[$1])/$3.scale[$1]
if(!this.__LZdeleted){
var $lzsc$612561486=this.setters
if($lzsc$612561486&&$1 in $lzsc$612561486){
this[$lzsc$612561486[$1]]($lzsc$1148065457)
}else{
this[$1]=$lzsc$1148065457
var $lzsc$1136518057="on"+$1
if($lzsc$1136518057 in this){
if(this[$lzsc$1136518057].ready){
this[$lzsc$1136518057].sendEvent($lzsc$1148065457)
}
}
}
}
...
var $5=$1=="width"?"x":"y"
$3.update($5)
var $lzsc$1803729257=$4/$3.scale[$5]
if(!this.__LZdeleted){
var $lzsc$1814590994=this.setters
if($lzsc$1814590994&&$1 in $lzsc$1814590994){
this[$lzsc$1814590994[$1]]($lzsc$1803729257)
}else{
this[$1]=$lzsc$1803729257
var $lzsc$1964606778="on"+$1
if($lzsc$1964606778 in this){
if(this[$lzsc$1964606778].ready){
this[$lzsc$1964606778].sendEvent($lzsc$1803729257)
}
}
}
}
...
if(!this.__LZdeleted){
var $lzsc$1048382120=this.setters
if($lzsc$1048382120&&"focusable" in $lzsc$1048382120){
this[$lzsc$1048382120["focusable"]]($1)
}else{
this["focusable"]=$1
...
this.crepeat=this.repeat
if(this.from!=null){
var $lzsc$1695905065=this.target
var $lzsc$1051970767=this.attribute
var $lzsc$2060883344=Number(this.from)
if(!$lzsc$1695905065.__LZdeleted){
var $lzsc$801681346=$lzsc$1695905065.setters
if($lzsc$801681346&&$lzsc$1051970767 in $lzsc$801681346){
$lzsc$1695905065[$lzsc$801681346[$lzsc$1051970767]]($lzsc$2060883344)
}else{
$lzsc$1695905065[$lzsc$1051970767]=$lzsc$2060883344
var $lzsc$751884115="on"+$lzsc$1051970767
if($lzsc$751884115 in $lzsc$1695905065){
if($lzsc$1695905065[$lzsc$751884115].ready){
$lzsc$1695905065[$lzsc$751884115].sendEvent($lzsc$2060883344)
}
}
}
}
...
if(this.from!=null){
var $lzsc$870413481=this.target
var $lzsc$904080303=this.attribute
var $lzsc$719283217=this.from
if(!$lzsc$870413481.__LZdeleted){
var $lzsc$1233471348=$lzsc$870413481.setters
if($lzsc$1233471348&&$lzsc$904080303 in $lzsc$1233471348){
$lzsc$870413481[$lzsc$1233471348[$lzsc$904080303]]($lzsc$719283217)
}else{
$lzsc$870413481[$lzsc$904080303]=$lzsc$719283217
var $lzsc$1938382777="on"+$lzsc$904080303
if($lzsc$1938382777 in $lzsc$870413481){
if($lzsc$870413481[$lzsc$1938382777].ready){
$lzsc$870413481[$lzsc$1938382777].sendEvent($lzsc$719283217)
}
}
}
}
...
if(this.target[$1].c<=0){
this.target[$1].c=0
var $lzsc$350865761=this.target
var $lzsc$123226037=this.attribute
var $lzsc$894724386=this.target[$1].v
if(!$lzsc$350865761.__LZdeleted){
var $lzsc$392164218=$lzsc$350865761.setters
if($lzsc$392164218&&$lzsc$123226037 in $lzsc$392164218){
$lzsc$350865761[$lzsc$392164218[$lzsc$123226037]]($lzsc$894724386)
}else{
$lzsc$350865761[$lzsc$123226037]=$lzsc$894724386
var $lzsc$2042456643="on"+$lzsc$123226037
if($lzsc$2042456643 in $lzsc$350865761){
if($lzsc$350865761[$lzsc$2042456643].ready){
$lzsc$350865761[$lzsc$2042456643].sendEvent($lzsc$894724386)
}
}
}
}
...
var $lzsc$33785718=this.target
var $lzsc$1443275579=this.attribute
var $lzsc$1867745620=this.target[this.attribute]+$2
if(!$lzsc$33785718.__LZdeleted){
var $lzsc$405833160=$lzsc$33785718.setters
if($lzsc$405833160&&$lzsc$1443275579 in $lzsc$405833160){
$lzsc$33785718[$lzsc$405833160[$lzsc$1443275579]]($lzsc$1867745620)
}else{
$lzsc$33785718[$lzsc$1443275579]=$lzsc$1867745620
var $lzsc$1306907647="on"+$lzsc$1443275579
if($lzsc$1306907647 in $lzsc$33785718){
if($lzsc$33785718[$lzsc$1306907647].ready){
$lzsc$33785718[$lzsc$1306907647].sendEvent($lzsc$1867745620)
}
}
}
}
...
var $lzsc$950072549=this.node
var $lzsc$1847585633=this.setAttr
var $lzsc$405622309=this.data==null?null:this.data
if(!$lzsc$950072549.__LZdeleted){
var $lzsc$51019291=$lzsc$950072549.setters
if($lzsc$51019291&&$lzsc$1847585633 in $lzsc$51019291){
$lzsc$950072549[$lzsc$51019291[$lzsc$1847585633]]($lzsc$405622309)
}else{
$lzsc$950072549[$lzsc$1847585633]=$lzsc$405622309
var $lzsc$1819433475="on"+$lzsc$1847585633
if($lzsc$1819433475 in $lzsc$950072549){
if($lzsc$950072549[$lzsc$1819433475].ready){
$lzsc$950072549[$lzsc$1819433475].sendEvent($lzsc$405622309)
}
}
}
}
...
var $lzsc$1010034021=this.axis
var $lzsc$1738334950=this.totalsize
if(!$7.__LZdeleted){
var $lzsc$837722228=$7.setters
if($lzsc$837722228&&$lzsc$1010034021 in $lzsc$837722228){
$7[$lzsc$837722228[$lzsc$1010034021]]($lzsc$1738334950)
}else{
$7[$lzsc$1010034021]=$lzsc$1738334950
var $lzsc$386565543="on"+$lzsc$1010034021
if($lzsc$386565543 in $7){
if($7[$lzsc$386565543].ready){
$7[$lzsc$386565543].sendEvent($lzsc$1738334950)
}
}
}
}
...
var $lzsc$1239686764=this.cloneimmediateparent
var $lzsc$187520186=this.sizeAxis
var $lzsc$1450936321=this.nodes.length*this.totalsize-this.spacing
if(!$lzsc$1239686764.__LZdeleted){
var $lzsc$1022374240=$lzsc$1239686764.setters
if($lzsc$1022374240&&$lzsc$187520186 in $lzsc$1022374240){
$lzsc$1239686764[$lzsc$1022374240[$lzsc$187520186]]($lzsc$1450936321)
}else{
$lzsc$1239686764[$lzsc$187520186]=$lzsc$1450936321
var $lzsc$1381388952="on"+$lzsc$187520186
if($lzsc$1381388952 in $lzsc$1239686764){
if($lzsc$1239686764[$lzsc$1381388952].ready){
$lzsc$1239686764[$lzsc$1381388952].sendEvent($lzsc$1450936321)
}
}
}
}
...
if($12){
this.clones[$11]=$12
var $lzsc$1412233215=this.axis
var $lzsc$185916781=($11+$4)*this.totalsize
if(!$12.__LZdeleted){
var $lzsc$1382669642=$12.setters
if($lzsc$1382669642&&$lzsc$1412233215 in $lzsc$1382669642){
$12[$lzsc$1382669642[$lzsc$1412233215]]($lzsc$185916781)
}else{
$12[$lzsc$1412233215]=$lzsc$185916781
var $lzsc$321119164="on"+$lzsc$1412233215
if($lzsc$321119164 in $12){
if($12[$lzsc$321119164].ready){
$12[$lzsc$321119164].sendEvent($lzsc$185916781)
}
}
}
}
...
this.clones[$14]=$23
var $lzsc$1569958315=this.axis
if(!$23.__LZdeleted){
var $lzsc$1347716853=$23.setters
if($lzsc$1347716853&&$lzsc$1569958315 in $lzsc$1347716853){
$23[$lzsc$1347716853[$lzsc$1569958315]]($24)
}else{
$23[$lzsc$1569958315]=$24
var $lzsc$1209783410="on"+$lzsc$1569958315
if($lzsc$1209783410 in $23){
if($23[$lzsc$1209783410].ready){
$23[$lzsc$1209783410].sendEvent($24)
}
}
}
}
...
var $lzsc$647375576=this.sizeAxis
if(!($23.__LZdeleted||true&&$23[$lzsc$647375576]==$17)){
var $lzsc$182695815=$23.setters
if($lzsc$182695815&&$lzsc$647375576 in $lzsc$182695815){
$23[$lzsc$182695815[$lzsc$647375576]]($17)
}else{
$23[$lzsc$647375576]=$17
var $lzsc$2037983067="on"+$lzsc$647375576
if($lzsc$2037983067 in $23){
if($23[$lzsc$2037983067].ready){
$23[$lzsc$2037983067].sendEvent($17)
}
}
}
}
...
var $lzsc$706339790=this.cloneimmediateparent
var $lzsc$585354043=this.sizeAxis
if(!$lzsc$706339790.__LZdeleted){
var $lzsc$636876716=$lzsc$706339790.setters
if($lzsc$636876716&&$lzsc$585354043 in $lzsc$636876716){
$lzsc$706339790[$lzsc$636876716[$lzsc$585354043]]($10)
}else{
$lzsc$706339790[$lzsc$585354043]=$10
var $lzsc$2128783979="on"+$lzsc$585354043
if($lzsc$2128783979 in $lzsc$706339790){
if($lzsc$706339790[$lzsc$2128783979].ready){
$lzsc$706339790[$lzsc$2128783979].sendEvent($10)
}
}
}
}
...
for(var $3 in $2){
var $1=$2[$3]
var $lzsc$651530282=global[$1.c]
var $lzsc$1502308585=$1.n
var $lzsc$59680245=$1.v
if(!$lzsc$651530282.__LZdeleted){
var $lzsc$532315475=$lzsc$651530282.setters
if($lzsc$532315475&&$lzsc$1502308585 in $lzsc$532315475){
$lzsc$651530282[$lzsc$532315475[$lzsc$1502308585]]($lzsc$59680245)
}else{
$lzsc$651530282[$lzsc$1502308585]=$lzsc$59680245
var $lzsc$1029622215="on"+$lzsc$1502308585
if($lzsc$1029622215 in $lzsc$651530282){
if($lzsc$651530282[$lzsc$1029622215].ready){
$lzsc$651530282[$lzsc$1029622215].sendEvent($lzsc$59680245)
}
}
}
}
